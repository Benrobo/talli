...
app.initializeRoutes([healthRoute, authRoute, userRoute, workspaceRoute, chatRoute, collectionRoute, savingsRoute, walletRoute, transferRoute, paymentsRoute, receiptRoute, webhookRoute, billSplitRoute]);
